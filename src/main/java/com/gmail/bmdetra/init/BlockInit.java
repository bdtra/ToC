...
public class BlockInit
{
    ...
    {
        event.getRegistry().register(new Empty_Tome(Block.Properties.create(Material.WOOD).notSolid().hardnessAndResistance(0.3f,15.0f).sound(SoundType.WOOD)).setRegistryName("empty_tome"));
    }
